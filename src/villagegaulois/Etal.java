...
public class Etal {
	...
	public String libererEtal() {
		...
		if (etalOccupe) {
			...
			chaine.append("Cet étal n'a aucun vendeur.\n");
		}
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur)
		...
		if (quantiteAcheter < 1) {
			throw new IllegalArgumentException("Quantité à acheter nulle ou négative.\n");
		}
		if (!etalOccupe) {
			throw new IllegalStateException("Accés à un étal vide.\n");
		}
		StringBuilder chaine = new StringBuilder();
		chaine.append(
